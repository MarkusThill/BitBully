...
private:
  ...
  const short int m_cMoveRating[42] = {
      7,  9,  11, 10, 8,  6,  9,  13, 17, 16, 12, 8,  11, 17,
      23, 22, 16, 10, 15, 21, 27, 26, 20, 14, 11, 17, 23, 22,
      16, 10, 9,  13, 17, 16, 12, 8,  7,  9,  11, 10, 8,  6};

  const uint64_t m_cColumnMasks[7] = {
      0x3F000000000LL, 0xFC0000000LL, 0x3F000000LL, 0xFC0000LL,
      0x3F000LL,       0xFC0LL,       0x3FLL};

  const uint64_t m_cZobristKeys[2][42] = {
      2704506115994628LL,    886077597871704230LL,  49389502572435258LL,
      82333996817139652LL,   263967204879563328LL,  81975673952415600LL,
      73398886193708064LL,   1595863713887220963LL, 46261610206381440LL,
      58705059883690202LL,   231696507446129885LL,  22606427398883328LL,
      12595346104058426LL,   4097820997223100LL,    101324622437045280LL,
      31779374605300125LL,   35633797708573350LL,   22416112427922675LL,
      36363358841386824LL,   4173667863902779612LL, 9131869703157656LL,
      14138249969764235LL,   214348955873908032LL,  58547228054472360LL,
      55740094356093127LL,   1777939723684020LL,    362858203316162568LL,
      28975890403315160LL,   1242349240448115806LL, 59601464106441712LL,
      9110872168202946LL,    10631234269963860LL,   16888881020037981LL,
      1159792823631456LL,    36205525950397736LL,   47068546447093808LL,
      375817237236357603LL,  32189775283681470LL,   1493718293429439LL,
      20793138156733824LL,   101478045365676084LL,  110552240521049760LL,
      19298943901485610LL,   6548220796761019LL,    1777628907278452803LL,
      11891769178478592LL,   3564258696970080LL,    236708853179436288LL,
      349182760342233125LL,  429289086240375LL,     121921717543355343LL,
      31495429917193824LL,   5694462647075520LL,    30758051047680284LL,
      1365712501364505581LL, 17363511325679223LL,   119226791868480LL,
      6220173073409360LL,    11647770880598424LL,   24507207907919492LL,
      551903736927872LL,     2097977134396858LL,    3108717381973636075LL,
      ...
      290694253237906321LL,  3460150747465650LL,    12108862858045894LL,
      124792798959719156LL,  6572334569141376LL,    2726416766762766LL,
      378828340783306008LL,  72087612995472200LL,   113983283880328672LL,
      376285078915283LL,     62397498210717124LL,   1193066389676430LL};

  const uint64_t m_cZobristKeys10[7] = {0LL,
                                        2704506115994628LL,
  ...
  const uint64_t m_cZobristKeys11[7] = {0LL,
                                        73398886193708064LL,
  ...
  const uint64_t m_cZobristKeys12[7] = {0LL,
                                        12595346104058426LL,
                                        4097820997223100LL,
  ...
  const uint64_t m_cZobristKeys13[7] = {0LL,
                                        36363358841386824LL,
  ...
  const uint64_t m_cZobristKeys14[7] = {0LL,
                                        55740094356093127LL,
                                        1777939723684020LL,
  ...
  const uint64_t m_cZobristKeys15[7] = {0LL,
                                        9110872168202946LL,
                                        10631234269963860LL,
                                        16888881020037981LL,
                                        1159792823631456LL,
  ...
  const uint64_t m_cZobristKeys16[7] = {0LL,
  ...
  const uint64_t m_cZobristKeys20[7] = {0LL,
                                        19298943901485610LL,
                                        6548220796761019LL,
  ...
  const uint64_t m_cZobristKeys21[7] = {0LL,
  ...
  const uint64_t m_cZobristKeys22[7] = {0LL,
  ...
  const uint64_t m_cZobristKeys23[7] = {0LL,
                                        551903736927872LL,
                                        2097977134396858LL,
  ...
  const uint64_t m_cZobristKeys24[7] = {0LL,
                                        65628472867223040LL,
  ...
  const uint64_t m_cZobristKeys25[7] = {0LL,
  ...
  const uint64_t m_cZobristKeys26[7] = {0LL,
  ...
  const uint64_t m_cMasksColumn0[6] = {2199023255552ULL, 1099511627776ULL,
                                       549755813888ULL,  274877906944ULL,
                                       137438953472ULL,  68719476736ULL};

  const uint64_t m_cMasksColumn1[6] = {34359738368ULL, 17179869184ULL,
                                       8589934592ULL,  4294967296ULL,
                                       2147483648ULL,  1073741824ULL};

  const uint64_t m_cMasksColumn2[6] = {536870912ULL, 268435456ULL, 134217728ULL,
                                       67108864ULL,  33554432ULL,  16777216ULL};

  const uint64_t m_cMasksColumn3[6] = {8388608ULL, 4194304ULL, 2097152ULL,
                                       1048576ULL, 524288ULL,  262144ULL};

  const uint64_t m_cMasksColumn4[6] = {131072ULL, 65536ULL, 32768ULL,
                                       16384ULL,  8192ULL,  4096ULL};

  const uint64_t m_cMasksColumn5[6] = {2048ULL, 1024ULL, 512ULL,
                                       256ULL,  128ULL,  64ULL};

  const uint64_t m_cMasksColumn6[6] = {32ULL, 16ULL, 8ULL, 4ULL, 2ULL, 1ULL};

  const uint64_t m_cMasks[7][6] = {2199023255552ULL,
                                   1099511627776ULL,
                                   549755813888ULL,
                                   274877906944ULL,
                                   137438953472ULL,
  ...
  const uint64_t m_cInverseMasks[7][6] = {
      18446741874686296063ULL, 18446742974197923839ULL,
      18446743523953737727ULL, 18446743798831644671ULL,
      18446743936270598143ULL, 18446744004990074879ULL,
      18446744039349813247ULL, 18446744056529682431ULL,
      18446744065119617023ULL, 18446744069414584319ULL,
      18446744071562067967ULL, 18446744072635809791ULL,
      18446744073172680703ULL, 18446744073441116159ULL,
      18446744073575333887ULL, 18446744073642442751ULL,
      18446744073675997183ULL, 18446744073692774399ULL,
      18446744073701163007ULL, 18446744073705357311ULL,
      18446744073707454463ULL, 18446744073708503039ULL,
      18446744073709027327ULL, 18446744073709289471ULL,
      18446744073709420543ULL, 18446744073709486079ULL,
      18446744073709518847ULL, 18446744073709535231ULL,
      18446744073709543423ULL, 18446744073709547519ULL,
      18446744073709549567ULL, 18446744073709550591ULL,
      18446744073709551103ULL, 18446744073709551359ULL,
      18446744073709551487ULL, 18446744073709551551ULL,
      18446744073709551583ULL, 18446744073709551599ULL,
      18446744073709551607ULL, 18446744073709551611ULL,
...
public:
  ...
  bool isColumnFull(int column) { return m_columnHeight[column] == 6; }
  ...
  bool initHash() {
    ...
    HASHE = (TranspositionTableElement *)malloc(
        HASHSIZE * sizeof(TranspositionTableElement));
    LHASHE = (TranspositionTableElement *)malloc(
        LHASHSIZE * sizeof(TranspositionTableElement));
  ...
  void setDepthTie() { m_depthTie = 42 - BrettCount(); }

  void Reset(void) {
    /*Setzt das Spielfeld zurück. Dafür müssen die beiden Variablen m_fieldP1
     * und m_fieldP2 auf 0 gesetzt werden und die Höhe für jede Spalte muss auf
     * 0 gesetzt werden.*/
    m_fieldP1 = 0LL;
    m_fieldP2 = 0LL;
  ...
  int BrettCount() {
    /*Zählt die Steine, die auf dem Spielfeld gesetzt wurden und gibt die Anzahl
     * zurück*/
    // TODO: constexpr for loop?
    return (m_columnHeight[0] + m_columnHeight[1] + m_columnHeight[2] +
            m_columnHeight[3] + m_columnHeight[4] + m_columnHeight[5] +
            m_columnHeight[6]);
  }
  ...
  /*char DrohungenErmitteln()
  {
          ...
          for(i=0;i<7;i++)
                  for(j=m_columnHeight[i];j<6;j++)
                          if(Gewinnstellung(i,j,m_cPlayer1) ||
  Gewinnstellung(i,j,m_cPlayer2)) x |= (1 << (6-i)); return x;
  }
  */
  ...
  /*int  ComputerAnziehender(int spalte) {
      int x;
      if (GameOver) //Falls das Spiel bereits vorbei ist, soll der Spieler
  keinen Zug mehr machen d?rfen return -1; if (m_columnHeight[spalte] < 6 &&
  Modus == 2) { SteinSetzen(spalte, m_cPlayer1); if (Gewinnstellung1(spalte,
  m_columnHeight[spalte] - 1))  //Falls der Spieler mit seinem Zug gewonnen hat
          {
          ...
          if ((m_fieldP1 | m_fieldP2) == 0x3FFFFFFFFFFLL)  //Falls das Spielfeld
  Voll ist
          {
              //std::cout << "Das Spiel endet Unentschieden!!!";
              GameOver = true; //Damit keienr der beiden einen Stein mehr setzen
  kann return 0;
          }
          if (SpielBeenden2()) //Es wird vor dem Zug des Computers bereits
  geschaut, ob er gewinnen kann, wodurch dann nachher ein weiterer Zug des
  Spielers verhindert werden kann GameOver = true;        //Wird auf true
  gesetzt, da bei Gewinn das Spiel vorbei ist und der Spieler keine weiteren
  Z?ge machen k?nnen soll else std::cout << "Warten Sie bitte, das Programm
  rechnet..."; if (BrettCount() < 8) { x =
  WurzelMethodeStartComputerAnziehender(0, -9999, 9999, HoeheErmitteln());
              SteinSetzen(x, m_cPlayer2);
          } else {
              m_depthTie = 42 - BrettCount();
              m_maxSearchDepth = 100;
              HoeheErmitteln();
              auto [value, x] = WurzelMethodeComputerAnziehender(0, -9999, 9999,
  HoeheErmitteln()); SteinSetzen(x, m_cPlayer2);
          }
  ...
  auto toMoveSequence() {
    ...
    if (!toMoveSequence(board, colHeight,
                        BrettCount() % 2 == 0 ? P_YELLOW : P_RED, sequence)) {
      sequence = {};
    }
  ...
  toMoveSequence(std::array<std::array<int32_t, N_ROWS>, N_COLUMNS> &board,
    ...
    // Iterate through columns: First try to remove stones, which set free a
    // stone of the other player This reduces the risk of ending up in a
    // situation, where the stones of one player are "locked" beneath the stones
    // of another player
...
das übergebene Loch setzen würde*/
  ...
  int getHeight(int column) { return m_columnHeight[column]; }

  int SpielBeendenStellung(bool spieler) {
    /*Überprüft, ob der übergebene Spieler gewinnen könnte. Wenn er gewinnen
kann, dann wird die m_cColumnMasks, in die er setzen müsste, um zu gewinnnen,
zurückgegeben, ansonsten (-1).*/
    int x;
    for (x = 0; x < 7; x++) {
...
ist.# Wenn ja, dann wird ein true zurückgeben, wenn nicht dann ein false*/
  ...
  bool UnentschiedenUeberpruefen(void) {
    // Reihe 6 Horizontal
    if (!((m_fieldP1 & 0x1041040000LL) && (m_fieldP2 & 0x1041040000LL)))
      return false;
    ...
    if (!((m_fieldP1 & 0x10204080000LL) && (m_fieldP2 & 0x10204080000LL)))
      return false;
    if (!((m_fieldP1 & 0x408102000LL) && (m_fieldP2 & 0x408102000LL)))
      return false;
    ...
    if (!((m_fieldP1 & 0x20408100000LL) && (m_fieldP2 & 0x20408100000LL)))
      return false;
    if (!((m_fieldP1 & 0x810204000LL) && (m_fieldP2 & 0x810204000LL)))
      return false;
    ...
    if (!((m_fieldP1 & 0x10410400000LL) && (m_fieldP2 & 0x10410400000LL)))
      return false;
    if (!((m_fieldP1 & 0x410410000LL) && (m_fieldP2 & 0x410410000LL)))
      return false;
    ...
    if (!((m_fieldP1 & 0x20820800000LL) && (m_fieldP2 & 0x20820800000LL)))
      return false;
    if (!((m_fieldP1 & 0x820820000LL) && (m_fieldP2 & 0x820820000LL)))
      return false;
  ...
  /*short SiegerErmittelnGenau2(const short *s) //Ist ein wenig langsamer als
  die ursprüngliche Funktion
  {
          ...
          while(Hs<6)
          {
                  ...
                  if(anz2>1 && anz1>1) //Probieren ob weglassen dieser beiden
  Zeilen schneller ist... return (-1); Hs++;
          }
          //Prüfen ob Spieler2 eine Vertikale Drohung aufbauen kann und somit
  den Gegner in Zugzwang bringen kann,
          //wodurch möglicherweise auch eine gerade Drohung von Spieler2 zum
  Sieg führt if(m_columnHeight[s[0]]>1) if( (m_fieldP2 &
  m_cMasks[s[0]][m_columnHeight[s[0]]-1]) )  //Wenn oberster Stein von Spieler2
  ist
                          {
                                  if(anz1==0)
                                  {
                                          if( (m_fieldP2 &
  m_cMasks[s[0]][m_columnHeight[s[0]]-2]) ) //Wenn der Stein darunter auch von
  Spieler2 ist if(m_columnHeight[s[0]]<4 && Gewinnstellung2(s[0],
  m_columnHeight[s[0]]+2)) //Wenn Spieler2 einen Gewinn durch eine vertikale
  Drohung erzwingen kann return 1000;
                                  }
                                  else if( (m_fieldP2 &
  m_cMasks[s[0]][m_columnHeight[s[0]]-2]) ) return (-1);
                          }
          if(m_columnHeight[s[1]]>1)
                          if( (m_fieldP2 &
  m_cMasks[s[1]][m_columnHeight[s[1]]-1]) )  //Wenn oberster Stein von Spieler2
  ist
                          {
                                  if(anz2==0)
                                  {
                                          if( (m_fieldP2 &
  m_cMasks[s[1]][m_columnHeight[s[1]]-2]) ) //Wenn der Stein darunter auch von
  Spieler2 ist if(m_columnHeight[s[1]]<4 && Gewinnstellung2(s[1],
  m_columnHeight[s[1]]+2)) //Wenn Spieler2 einen Gewinn durch eine vertikale
  Drohung erzwingen kann return 1000;
                                  }
                                  else if( (m_fieldP2 &
  m_cMasks[s[1]][m_columnHeight[s[1]]-2]) ) return (-1);
                          }
          if(anz1==0)
          {
                  if(anz2==0)
                  ...
                  if( (dro1 & GERADEREIHEN) > (dro2 & UNGERADEREIHEN)) //Wenn
  eine  gerade Drohung von Spieler1 am untersten ist return -1000; if( (dro2 &
  UNGERADEREIHEN) > (dro1 & GERADEREIHEN)) //Wenn eine ungerade Drohung von
  Spieler2 am untersten ist return 1000; return 0;  //Wenn Spieler1 nur ungerade
  und Spieler2 nur gerade Drohungen hat
          }
          if(anz2==0)
          {
  ...
  short SpielBaum1Generate(const short instance, short alpha, short beta,
      ...
      for (x = 0; moves[x] != -1; x++) {
        if (m_columnHeight[moves[x]] < 4) {
          ...
          if (Gewinnstellung1(moves[x], m_columnHeight[moves[x]]))
            if (Gewinnstellung1(moves[x], m_columnHeight[moves[x]] + 1) &&
                !SpielBeenden2()) {
              m_columnHeight[moves[x]]--;
              return -1000;
            }
    ...
    if (y > -1) {
      ...
      if (instance > 13)
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys[0][y * 6 - 1 + m_columnHeight[y]]);
      else
        rueck = SpielBaum2Generate(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys[0][y * 6 - 1 + m_columnHeight[y]], symM);
      ...
      if (z > -1) {
        ...
        if (instance > 13)
          rueck = rueck = Spielbaum2ComputerAnziehender(
              instance + 1, alpha, beta,
              ZKey ^ m_cZobristKeys[0][z * 6 - 1 + m_columnHeight[z]]);
        else
          rueck = SpielBaum2Generate(
              instance + 1, alpha, beta,
              ZKey ^ m_cZobristKeys[0][z * 6 - 1 + m_columnHeight[z]], symM);
    ...
    if (q != -1) {
      if (m_columnHeight[q] < 5 && m_columnHeight[q] % 2 == 0 && later == -1 &&
          Gewinnstellung1(q, m_columnHeight[q] + 1))
        later = q;
      else {
        t = m_fieldP1;
        ...
        rueck = SpielBaum2Generate(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys[0][q * 6 - 1 + m_columnHeight[q]], symM);
        m_fieldP1 = t;
        m_columnHeight[q]--;
        if (rueck <= alpha)
          return rueck;
    ...
    for (x = 0; moves[x] > -1; x++) {
      ...
      if (m_columnHeight[moves[x]] < 5 && m_columnHeight[moves[x]] % 2 == 0 &&
        ...
        if (instance > 13)
          rueck = Spielbaum2ComputerAnziehender(
              instance + 1, alpha, beta,
              ZKey ^ m_cZobristKeys[0][moves[x] * 6 - 1 +
                                       m_columnHeight[moves[x]]]);
        else
          rueck = SpielBaum2Generate(
              instance + 1, alpha, beta,
  ...
  short SpielBaum2Generate(const short instance, short alpha, short beta,
      ...
      for (x = 0; moves[x] != -1; x++) {
        if (m_columnHeight[moves[x]] < 4) {
          ...
          if (Gewinnstellung2(moves[x], m_columnHeight[moves[x]]))
            if (Gewinnstellung2(moves[x], m_columnHeight[moves[x]] + 1) &&
                !SpielBeenden1()) {
              m_columnHeight[moves[x]]--;
              return 1000;
            }
    ...
    if (y > -1) {
      ...
      rueck = SpielBaum1Generate(
          instance + 1, alpha, beta,
          ZKey ^ m_cZobristKeys[1][y * 6 - 1 + m_columnHeight[y]], symM);
      ...
      if (z > -1) {
        ...
        rueck = SpielBaum1Generate(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys[1][z * 6 - 1 + m_columnHeight[z]], symM);
    ...
    if (q != -1) {
      if (m_columnHeight[q] < 4 && m_columnHeight[q] % 2 && later == -1 &&
          Gewinnstellung2(q, m_columnHeight[q] + 1))
        later = q;
      else {
        t = m_fieldP2;
        ...
        rueck = SpielBaum1Generate(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys[1][q * 6 - 1 + m_columnHeight[q]], symM);
    ...
    for (x = 0; moves[x] > -1; x++) {
      ...
      if (m_columnHeight[moves[x]] < 4 && m_columnHeight[moves[x]] % 2 &&
        ...
        rueck = SpielBaum1Generate(
            instance + 1, alpha, beta,
            ZKey ^
                m_cZobristKeys[1][moves[x] * 6 - 1 + m_columnHeight[moves[x]]],
            symM);
                                                                                                                            ...
                                                                                                                            short WurzelMethodeComputerAnziehender(short instance, short alpha, short beta, uint64_t ZKey)
{
...
#else
  std::tuple<short, short> WurzelMethodeComputerAnziehender(short instance,
                                                            short alpha,
                                                            short beta,
                                                            uint64_t ZKey) {
    ...
    for (x = 0; moves[x] > -1; x++) {
      ...
      rueck = SpielBaum1Generate(
          instance + 1, alpha, beta,
          ZKey ^ m_cZobristKeys[1][moves[x] * 6 + m_columnHeight[moves[x]] - 1],
          symMoeglich());
  ...
  short Spielbaum1ComputerAnziehender(const short instance, short alpha,
    ...
    if (x != 3 && *(m_columnHeight + 3) < 6) {
      if (m_columnHeight[3] < 5 /*&& *(m_columnHeight+3)%2==0*/ &&
          Gewinnstellung1(3, *(m_columnHeight + 3) + 1))
        later = 3;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys13[m_columnHeight[3]]);
    ...
    if (x != 4 && *(m_columnHeight + 4) < 6) {
      if (later == -1 &&
          m_columnHeight[4] < 5 /*&& *(m_columnHeight+4)%2==0*/ &&
          Gewinnstellung1(4, *(m_columnHeight + 4) + 1))
        later = 4;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys14[m_columnHeight[4]]);
    ...
    if (x != 2 && *(m_columnHeight + 2) < 6) {
      if (later == -1 &&
          m_columnHeight[2] < 5 /*&& *(m_columnHeight+2)%2==0*/ &&
          Gewinnstellung1(2, *(m_columnHeight + 2) + 1))
        later = 2;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys12[m_columnHeight[2]]);
    ...
    if (x != 5 && *(m_columnHeight + 5) < 6) {
      if (later == -1 &&
          m_columnHeight[5] < 5 /*&& *(m_columnHeight+5)%2==0*/ &&
          Gewinnstellung1(5, *(m_columnHeight + 5) + 1))
        later = 5;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys15[m_columnHeight[5]]);
    ...
    if (x != 1 && *(m_columnHeight + 1) < 6) {
      if (later == -1 &&
          m_columnHeight[1] < 5 /*&& *(m_columnHeight+1)%2==0*/ &&
          Gewinnstellung1(1, *(m_columnHeight + 1) + 1))
        later = 1;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys11[m_columnHeight[1]]);
    ...
    if (x != 6 && *(m_columnHeight + 6) < 6) {
      if (later == -1 &&
          m_columnHeight[6] < 5 /*&& *(m_columnHeight+6)%2==0*/ &&
          Gewinnstellung1(6, *(m_columnHeight + 6) + 1))
        later = 6;
      else {
        t = m_fieldP1;
        ...
        rueck = Spielbaum2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys16[m_columnHeight[6]]);
    ...
    if (x != 0 && (*m_columnHeight) < 6) {
      ...
      rueck = Spielbaum2ComputerAnziehender(
          instance + 1, alpha, beta,
          ZKey ^ m_cZobristKeys10[m_columnHeight[0]]);
  ...
  short Spielbaum2ComputerAnziehender(const short instance, short alpha,
    ...
    if (instance < 24) {
      ...
      if (x > -1) {
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
    ...
    if (x != 3 && *(m_columnHeight + 3) < 6) {
      if (m_columnHeight[3] < 4 && *(m_columnHeight + 3) % 2 &&
          Gewinnstellung2(3, *(m_columnHeight + 3) + 1))
        later = 3;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys23[m_columnHeight[3]]);
    ...
    if (x != 4 && *(m_columnHeight + 4) < 6) {
      if (m_columnHeight[4] < 4 && later == -1 && *(m_columnHeight + 4) % 2 &&
          Gewinnstellung2(4, *(m_columnHeight + 4) + 1))
        later = 4;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys24[m_columnHeight[4]]);
    ...
    if (x != 2 && *(m_columnHeight + 2) < 6) {
      if (later == -1 && m_columnHeight[2] < 4 && *(m_columnHeight + 2) % 2 &&
          Gewinnstellung2(2, *(m_columnHeight + 2) + 1))
        later = 2;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys22[m_columnHeight[2]]);
    ...
    if (x != 5 && *(m_columnHeight + 5) < 6) {
      if (later == -1 && m_columnHeight[5] < 4 && *(m_columnHeight + 5) % 2 &&
          Gewinnstellung2(5, *(m_columnHeight + 5) + 1))
        later = 5;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys25[m_columnHeight[5]]);
    ...
    if (x != 1 && *(m_columnHeight + 1) < 6) {
      if (later == -1 && m_columnHeight[1] < 4 && *(m_columnHeight + 1) % 2 &&
          Gewinnstellung2(1, *(m_columnHeight + 1) + 1))
        later = 1;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys21[m_columnHeight[1]]);
    ...
    if (x != 6 && *(m_columnHeight + 6) < 6) {
      if (later == -1 && m_columnHeight[6] < 4 && *(m_columnHeight + 6) % 2 &&
          Gewinnstellung2(6, *(m_columnHeight + 6) + 1))
        later = 6;
      else {
        t = m_fieldP2;
        ...
        rueck = Spielbaum1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^ m_cZobristKeys26[m_columnHeight[6]]);
    ...
    if (x != 0 && *(m_columnHeight) < 6) {
      ...
      rueck = Spielbaum1ComputerAnziehender(
          instance + 1, alpha, beta,
          ZKey ^ m_cZobristKeys20[m_columnHeight[0]]);
  ...
  int BewertungComputerAnziehender(void) { return 3333; }

  short FreieSpalten(short *spalten) {
    short i = 0;
    /*int64_t x= (m_fieldP1 | m_fieldP2) & 0x1041041041LL;  //Bits z?hlen...
Wenn weniger als 5 Spalten voll sind funktion abbrechen short n = 0; if (x) do
          n++;
    while (0LL != (x = x&(x-1LL))) ;
if(n<5)
    return 0;*/
  ...
  /*short SiegerErmitteln1(const short x)  //scheint ein ganz kleines bisschen
  langsamer zu sein
  {
    ...
    /*switch(dro2*100 + dro1)
{
    case 2021: case 2011: case 2120: case 2020: case 1120: case 20: case 2000:
        return 1000;
    case 1011: case 1111: case 2111: case 1110: case 1121:case 1010: case 11:
case 1100: return -1000; default: //case 2010: //case 1020: //case 0: return 0;
}*/
  }

  void BuchLaden(std::string pfad) {
    /*Öffnet die Datenbank(die Datenbank muss sich im gleichen Verzeichnis wie
die Anwendung befinden) und lädt die Stellungen in die Variablen m_positionP1
und m_positionP2. Die Bewertungen der Stellungen werden im Array m_value[]
gespeichert.*/
    // int dateigroesse;
    long k = 0;
    // AnsiString
    // pfad=ExtractFileDir(Application->ExeName)+"\\m_openingBook8Ply.dat";
    // //Pfad der Datenbank
    ...
    if (fdatei.fail()) {
      std::cerr << "8-Steine Datenbank konnt nicht geöffnet werden. Das "
    ...
    auto dateigroesse = fdatei.tellg();
    if (dateigroesse != 102858) {
      std::cerr << "8-Steine Datenbank wurde manipuliert. Das Programm wird "
                   "beendet!!!"
                << std::endl;
      exit(EXIT_FAILURE);
    }
...
gespeichert.*/
    ...
    fdatei.open(pfad.c_str(), std::ios::in | std::ios::binary);
    if (fdatei.fail()) {
      std::cerr << "8-Steine Datenbank (2) konnt nicht geöffnet werden. Das "
                   "Programm wird beendet!!!";
      exit(0);
    }
    ...
    if (dateigroesse != 1477198) {
      std::cerr << "8-Steine Datenbank (2) wurde manipuliert. Das Programm "
                   "wird beendet!!!";
      exit(0);
    }
    fdatei.seekg(0, std::ios::beg);
    while (k < 86893) {
      m_pOpeningBook8Ply_2[k].m_value = 0;

      fdatei.read(
          reinterpret_cast<char *>(&m_pOpeningBook8Ply_2[k].m_positionP1),
          sizeof(uint64_t));
      fdatei.read(
          reinterpret_cast<char *>(&m_pOpeningBook8Ply_2[k].m_positionP2),
          sizeof(uint64_t));
      fdatei.read(reinterpret_cast<char *>(&m_pOpeningBook8Ply_2[k++].m_value),
                  sizeof(char));
    }
  ...
  short WurzelMethodeStartComputerAnziehender(const short instance, short alpha,
    ...
    for (x = 0; moves[x] > -1; x++) {
      if (m_columnHeight[moves[x]] % 2 && later == -1 &&
        ...
        m_fieldP2 |= m_cMasks[moves[x]][m_columnHeight[moves[x]]++];
        rueck = SpielbaumStart1ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^
                m_cZobristKeys[1][moves[x] * 6 - 1 + m_columnHeight[moves[x]]]);
  ...
  short SpielbaumStart1ComputerAnziehender(const short instance, short alpha,
    ...
    for (x = 0; moves[x] > -1; x++) {
      if (m_columnHeight[moves[x]] % 2 == 0 && later == -1 &&
        ...
        m_fieldP1 |= m_cMasks[moves[x]][m_columnHeight[moves[x]]++];
        rueck = SpielbaumStart2ComputerAnziehender(
            instance + 1, alpha, beta,
            ZKey ^
                m_cZobristKeys[0][moves[x] * 6 - 1 + m_columnHeight[moves[x]]]);
